...
public class BsBookclassServiceImpl implements BsBookclassService {
     ...
     */
    @Override
    public List<BsBookclass> selectAll() {
        return this.bsBookclassDao.selectAll();
    }
     ...
     */
    @Override
    public Integer insert(BsBookclass bsBookclass) {
        return this.bsBookclassDao.insert(bsBookclass);
    }
