...
public class BsAdminServiceImpl implements BsAdminService {
     ...
     */
    @Override
    public List<BsAdmin> queryAll(BsAdmin bsAdmin) {
        return this.bsAdminDao.queryAll(bsAdmin);
    }
     ...
     */
    @Override
    public Integer insert(BsAdmin bsAdmin) {
        return this.bsAdminDao.insert(bsAdmin);
    }
